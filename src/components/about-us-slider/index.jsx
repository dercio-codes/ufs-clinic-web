...
import { Box, Typography, Grid, Menu, Button , Tooltip , Paper} from "@mui/material";
  ...
  return (
    <Box sx={{ margin:'0 auto'}} >
      <Swiper
        ...
        className="mySwiper"
        style={{ width:'100%' , height:'auto' , padding:'0 100px 100px 100px' }}
      >
...
const Card = () => {
  return(
    <Paper elevation={5}  sx={{ border:'1px solid rgba(1,1,1,.1)' , width:'400px' , height:'auto' ,  }} >
      ...
      <Box sx={{ p:'0px 12px' }} >
      <Typography sx={{ fontSize:'21px' , margin:'12px 0' , fontWeight:'600' , textAlign:'left' }} >How To Deal With GBV? </Typography>
      ...
      <Button sx={{ scale:'0.9' , background:'#001842' , color:'white' , padding:'16px' , margin:'21px' , borderRadius:'32px' }} > READ MORE </Button>
      </Box>
      </Box>
    </Paper>
    )
